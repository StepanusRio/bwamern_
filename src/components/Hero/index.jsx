...
import ImageHero from 'assets/img/img-hero.jpg'
import ImageHero_ from 'assets/img/img-hero-frame.jpg'
  ...
  return (
    <section className="container pt-4">
        <div className="row align-items-center">
            <div className="col-auto pr-5" style={{width:530,height:458,}}>
                ...
                <div className="row" style={{marginTop:"80px"}}>
                    ...
                    <div className="col-auto">
                        <img src={IconCities} alt={`${props.data.cities} Cities`} width='32' height="32" />
                        <h6 className="mt-3">
